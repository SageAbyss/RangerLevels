// File: rl/sage/rangerlevels/items/bonuses/HachaTrabajadorCompulsivoEpico.java
...
public class HachaTrabajadorCompulsivoEpico extends RangerItemDefinition {
    public static final String ID = "hacha_trabajador_compulsivo_epico";

    public HachaTrabajadorCompulsivoEpico() {
        super(
                ID,
                Items.NETHERITE_AXE,
                Tier.EPICO,
    ...
    public ItemStack createStack(int amount) {
        ...
        double pct = ItemsConfig.get().axeBonus.epicPercent;
