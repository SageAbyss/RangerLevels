// File: rl/sage/rangerlevels/items/bonuses/PicoMineroPerdidoRaro.java
...
public class PicoMineroPerdidoRaro extends RangerItemDefinition {
    public static final String ID = "pico_minero_perdido_raro";

    public PicoMineroPerdidoRaro() {
        super(
                ID,
    ...
    public ItemStack createStack(int amount) {
        ...
        double pct = ItemsConfig.get().pickBonus.rarePercent;
