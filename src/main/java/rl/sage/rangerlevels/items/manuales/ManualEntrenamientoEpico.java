// File: rl/sage/rangerlevels/items/manuales/ManualEntrenamientoEpico.java
...
public class ManualEntrenamientoEpico extends RangerItemDefinition {
    public static final String ID = "manual_entrenamiento_epico";

    public ManualEntrenamientoEpico() {
        super(
                ID,
                PixelmonItems.curry_dex,
                Tier.EPICO,
                null,
    ...
    public ItemStack createStack(int amount) {
        ...
        List<IFormattableTextComponent> lore = Arrays.asList(
                ...
                new StringTextComponent("§7✧ Bonus de EXP: §6+15%"),
