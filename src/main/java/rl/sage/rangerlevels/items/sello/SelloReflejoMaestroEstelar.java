...
public class SelloReflejoMaestroEstelar extends RangerItemDefinition {
    public static final String ID = "sello_reflejo_maestro_estelar";

    public SelloReflejoMaestroEstelar() {
        super(
                ID,
    ...
    public ItemStack createStack(int amount) {
        ...
        double chance = ItemsConfig.get().selloReflejo.chanceEstelar;
        int durMin    = ItemsConfig.get().selloReflejo.durationEstelar;
