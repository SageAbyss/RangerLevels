// File: rl/sage/rangerlevels/items/reliquias/ReliquiaTemporalLegendario.java
...
public class ReliquiaTemporalLegendario extends RangerItemDefinition {
    public static final String ID = "reliquia_temporal_legendario";

    public ReliquiaTemporalLegendario() {
        super(
                ID,
                PixelmonItems.lure_casing_strong,
                Tier.LEGENDARIO,
                null,
                "✦ Reliquia Temporal Legendaria ✦",
                null
        );
    ...
    public ItemStack createStack(int amount) {
        ...
        List<IFormattableTextComponent> lore = Arrays.asList(
                ...
                new StringTextComponent("§7✧ Bonificación: +25%"),
