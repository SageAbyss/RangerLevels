...
/**
 * Tier ESTELAR: cofre del End
 */
public class MysteryBoxEstelar extends RangerItemDefinition {
    public static final String ID = "caja_misteriosa_estelar";

    public MysteryBoxEstelar() {
        super(
                ID,
                Items.ENDER_CHEST,
                Tier.ESTELAR,
                TextFormatting.AQUA,
                "❖ Caja Misteriosa Estelar ❖",
                null
        );
